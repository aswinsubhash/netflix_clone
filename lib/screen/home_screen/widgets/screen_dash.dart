...
import 'package:netflix/screen/coming_soon/screen_coming.dart';
import 'package:netflix/screen/download_screen/screen_download.dart';

import 'package:netflix/screen/home_screen/screen_home.dart';

import 'package:netflix/screen/search/screen_search.dart';
...
class _ScreenDashState extends State<ScreenDash> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: pages[_currentSelectedIntex],
